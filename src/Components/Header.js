        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            ...
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="16" cy="16" r="13" stroke="#666666" stroke-width="1.875"/>
                <path d="M21 8H11C9.34315 8 8 9.34315 8 11V21C8 22.6569 9.34315 24 11 24H21C22.6569 24 24 22.6569 24 21V11C24 9.34315 22.6569 8 21 8Z" stroke="#666666" stroke-width="1.875" />
                <circle cx="16" cy="16" r="4.5" stroke="#666666" stroke-width="1.875"/>
                <circle cx="21.5" cy="10.5" r="1" fill="#666666"/>
              </svg>
            </a>
          </li>
          <li>
